...
function noteWriting.CreateNote(pid,cmd)
	...
	noteWriting.StoreRecord(pid,"/storerecord book clear")
	noteWriting.StoreRecord(pid,"/storerecord book id " .. noteId)
	noteWriting.StoreRecord(pid,"/storerecord book name " .. noteName)
	noteWriting.StoreRecord(pid,"/storerecord book model " .. noteModel)
	noteWriting.StoreRecord(pid,"/storerecord book icon " .. noteIcon)
	noteWriting.StoreRecord(pid,"/storerecord book scrollState true")
	noteWriting.StoreRecord(pid,"/storerecord book weight " .. noteWeight)
	noteWriting.StoreRecord(pid,"/storerecord book value " .. noteValue)
	noteWriting.StoreRecord(pid,"/storerecord book text " .."<DIV ALIGN=\"CENTER\">" .. noteText .. "<p>")
	noteWriting.StoreRecord(pid,"/storerecord book skillId -1")
	noteWriting.CreateRecord(pid, "/createrecord book")
...
function noteWriting.StoreRecord(pid, cmd)
...
function noteWriting.CreateRecord(pid, cmd)
