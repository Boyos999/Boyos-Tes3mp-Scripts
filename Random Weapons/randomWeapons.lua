...
randomWeapons.CreateRandWeap = function(pid)
	local weapType = math.random(1,4)
	local weapBaseRand
	local weapBaseId
	...
	if weapType == 1 then
		...
		weapMinChopDmg = math.random(1,10)
		weapMaxChopDmg = math.random(20,50)
		weapMinSlashDmg = math.random(1,5)
		weapMaxSlashDmg = math.random(10,40)
		weapMinThrustDmg = math.random(1,2)
		weapMaxThrustDmg = math.random(3,10)
	...
	elseif weapType == 2 then
		...
		weapMinChopDmg = math.random(1,15)
		weapMaxChopDmg = math.random(20,80)
		weapMinSlashDmg = math.random(1,10)
		weapMaxSlashDmg = math.random(15,60)
		weapMinThrustDmg = math.random(1,2)
		weapMaxThrustDmg = math.random(3,10)
	...
	local newRefId = weapBaseId .. "_" .. Players[pid].name
