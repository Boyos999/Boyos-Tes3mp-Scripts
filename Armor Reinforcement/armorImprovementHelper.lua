...
function armorImprovementHelper.ArmorReinforcementFunction(pid, armorName, armorRating, armorHealth)
	...
	armorImprovementHelper.StoreRecord(pid, "/storerecord armor health " .. armorHealth)
	armorImprovementHelper.CreateRecord(pid, "/createrecord armor")
...
function armorImprovementHelper.StoreRecord(pid, cmd)
...
function armorImprovementHelper.CreateRecord(pid, cmd)
